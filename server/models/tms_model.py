...
class DriverDetails:
    ...
    vehicle_id = db.Column(db.Integer, db.ForeginKey("vehicles.vehicle_id"), nullable=False)
...
class Invoice(db.Model):
    ...
    shipment_id = db.Column(db.Integer, db.ForeignKey("shipments.shipment_id"), ondelete="CASCADE")
...
class Payment(db.Model):
    ...
    invoice_id = db.Column(db.Integer, db.ForeignKey("invoices.invoice_id"), ondelete="CASCADE")
    amount = db.Column(db.Float, nullable=False)
    payment_date = db.Column(db.DateTime, default=datetime.now(datetime.timezone.utc))
    status = db.Column(db.String(50), nullable=False)
