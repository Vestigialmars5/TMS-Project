...
from server.utils.data_cleanup import data_cleanup_create_user, data_cleanup_search, clean_user_id, data_cleanup_update_user
...
def get_users():
    if request.method == "GET":
        ...
        search, sort_by, sort_order, page, limit = data_cleanup_search(
            request.args)
